 ...
 * @author Lenovo
 */
public class FormListOfTicketSeller1 extends javax.swing.JFrame {

    ImageIcon icon = new ImageIcon("Background Profile.png");
    Image image = icon.getImage();
    
    
    public FormListOfTicketSeller1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormListOfTicketSeller1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormListOfTicketSeller1().setVisible(true);
            }
        });
    }
