 ...
 * @author Evan
 */
public class FormNotificationMessageAdmin extends javax.swing.JFrame {

    /**
     * Creates new form FormNotifikasiAdmin
     */
    public FormNotificationMessageAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("🎟️ Ada pesanan tiket baru dari pengguna! Apakah Anda ingin memprosesnya sekarang? ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(57, 57, 57)
                .addComponent(btnReject, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormNotificationMessageAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormNotificationMessageAdmin().setVisible(true);
            }
        });
    }
