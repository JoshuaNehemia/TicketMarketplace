 ...
 * @author Evan
 */
public class FormBroadcastEventMulai extends javax.swing.JFrame {

    /**
     * Creates new form FormNotifikasiAdmin
     */
    public FormBroadcastEventMulai() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("! Pengingat: Event-mu akan dimulai besok!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBroadcastEventMulai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormBroadcastEventMulai().setVisible(true);
            }
        });
    }
