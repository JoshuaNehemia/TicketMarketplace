 ...
 * @author Evan
 */
public class FormAcceptedNotificationMessageUser extends javax.swing.JFrame {

    /**
     * Creates new form FormNotifikasiAdmin
     */
    public FormAcceptedNotificationMessageUser() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAcceptedNotificationMessageUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAcceptedNotificationMessageUser().setVisible(true);
            }
        });
    }
