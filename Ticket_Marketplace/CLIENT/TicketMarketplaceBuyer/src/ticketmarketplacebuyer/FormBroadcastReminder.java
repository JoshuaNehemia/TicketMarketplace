 ...
 * @author Evan
 */
public class FormBroadcastReminder extends javax.swing.JFrame {

    /**
     * Creates new form FormNotifikasiAdmin
     */
    public FormBroadcastReminder() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("🎟️ Hai! Tiketmu masih menunggu konfirmasi!  ");

        jLabel4.setText("Kami segera proses pesananmu — pantau statusnya di aplikasi ya!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBroadcastReminder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormBroadcastReminder().setVisible(true);
            }
        });
    }
